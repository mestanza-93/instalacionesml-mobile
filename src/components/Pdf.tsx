          ...
          <div className="card-body">
            <div className="card card-default border-0 mx-2 my-0">
              <div className="card-body">
                <img
                  src={
                    process.env.PUBLIC_URL + "/assets/images/invoice_logo.jpeg"
                  }
                ...
                <table className="table table-borderless">
                  <tbody>
                    <tr>
                      ...
                      <td className="basic bigtext bold pb-0" id="today"></td>
                    </tr>
                    <tr>
            ...
            <div className="card card-default basic border-0 mx-3 my-0">
              <div className="card-body my-0">
                <table className="table table-sm table-products table-bordered">
                  <thead>
                    <tr>
                      <th className="text-center medium-text">Concepto</th>
                      <th className="text-center medium-text">Uds.</th>
                      <th className="text-center medium-text">Base Ud.</th>
                      <th className="text-center medium-text">Base total</th>
                      <th className="text-center medium-text">I.V.A. %</th>
                      <th className="text-center medium-text">I.V.A.</th>
                    </tr>
                  </thead>
                    ...
                    {invoice.concepts && invoice.concepts.length > 0
                      ? invoice.concepts.map((concept: any, index: number) => (
                          ...
                          <tr>
                            ...
                            <td className="text-center align-middle medium-text">
                              {parseFloat(concept.base).toFixed(2) + " €"}
                            </td>
                            <td className="text-center align-middle medium-text">
                              {parseFloat(concept.base).toFixed(2) + " €"}
                            </td>
                            <td className="text-center align-middle medium-text">
                              {parseFloat(concept.iva).toFixed(2) + " %"}
                            </td>
                            <td className="text-center align-middle medium-text">
                              {parseFloat(concept.iva).toFixed(2) + " %"}
                            </td>
          ...
          <div className="card-footer bg-transparent border-0 ml-5 mr-5">
            <div className="card card-default basic border-0 my-0">
              <table className="table table-sm table-price table-bordered">
                <thead>
                  <tr>
                    <th className="text-right medium-text">Base imponible</th>
            ...
            <div className="card card-default basic border-0 my-0">
              <table className="table table-sm table-payment table-bordered">
                <tbody id="payment-body">
                  ...
                  {invoice.comment != '' ? (
                    <tr>
                      <td className="text-center align-middle medium-text" colSpan={Number(2)}>
                        {invoice.comment}
                      </td>
                    </tr>
                  ) : (
