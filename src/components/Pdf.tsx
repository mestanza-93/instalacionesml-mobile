          ...
          <div className="card card-default">
            <div className="card-body">
                ...
                <div className="card-body">
                  <img
                    src={
                      ...
                      "/assets/images/invoice_logo.jpeg"
                    }
                  ...
                  <table className="table table-borderless 100">
                    <tbody>
                      <tr>
                        ...
                        <td
                          className="basic bigtext bold pb-0 w15"
                          id="today"
                        ></td>
                      </tr>
                      <tr>
              ...
              <div className="text-center my-0">
                <span className="basic invoice-title text-center bold">
                  FACTURA
                </span>
              </div>
              ...
              <div className="card card-default basic border-0 mx-3 my-0">
                <div className="card-head my-0">
                  <span className="basic bigtext bold">
                    Número de factura:{" "}
                  </span>
                ...
                <div className="card-body my-0">
                  <table className="table table-borderless table-customer">
                    <tbody>
                      <tr>
                        <td
                          className="bigtext bold px-1 py-1"
                          id="customer-name"
                        >
              ...
              <div className="card card-default basic border-0 mx-3 my-0">
                <div className="card-body my-0">
                  <table className="table table-sm table-products table-bordered">
                    <thead>
                      <tr>
                        <th className="text-center medium-text w34">
                          Concepto
                        </th>
                        <th className="text-center medium-text w10">Uds.</th>
                        <th className="text-center medium-text w12">
                          Base Ud.
                        </th>
                        <th className="text-center medium-text w12">
                          Base total
                        </th>
                        <th className="text-center medium-text w10">
                          I.V.A. %
                        </th>
            ...
            <div className="card-footer bg-transparent border-0 ml-5 mr-5">
              <div className="card card-default basic border-0 my-0">
                <table className="table table-sm table-price table-bordered w100">
                  <thead>
                    <tr>
                      <th className="text-right medium-text w65">
                        Base imponible
                      </th>
              ...
              <div className="small-text text-center">
                ...
                <span>
                  ...
                  realizar la facturación del mismo.
                </span>
                <br />
                <span>
                  Los datos proporcionados se conservarán mientras se mantenga
                  la relación comercial o durante los años necesarios para
                  cumplir con las
                </span>
                <br />
                <span>
                ...
                <span>
                  ...
                  estamos tratando sus datos personales por tanto tiene derecho
